...
function EditOrder() {
  ...
  useEffect(() => {
    const getOrder = async () => {
      try {
        ...
        const res = await axios.get(`https://minimalist-ecommerce-clone.onrender.com/user-orders/${id}`);
        setOrder(res.data);
  ...
  const updateOrder = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://minimalist-ecommerce-clone.onrender.com/admin/update-order/${id}`, {
        status
      });
